...
export const RECIPE_REGISTRY: Record<number, RecipeDefinition> = {
  ...
  19: {
    id: 19,
    name: 'Metal Hatchet',
    tier: CraftingTier.Intermediate,
    ingredients: [
      { itemId: 1, quantity: 100 },
      { itemId: 10, quantity: 75 },
    ],
    outputItemId: 24,
    outputQuantity: 1,
    craftTimeSeconds: 20,
  ...
  32: {
    id: 32,
    name: 'Revolver',
    tier: CraftingTier.Advanced,
    ingredients: [
      { itemId: 10, quantity: 150 },
  ...
  42: {
    ...
    ingredients: [
      { itemId: 10, quantity: 10 },
      { itemId: 15, quantity: 10 },
      { itemId: 6, quantity: 10 },
    ],
    outputItemId: 59,
    outputQuantity: 1,
    craftTimeSeconds: 10,
  ...
  46: {
    ...
    tier: CraftingTier.Military,
    ingredients: [
      { itemId: 12, quantity: 25 },
      { itemId: 10, quantity: 200 },
  ...
  50: {
    ...
    tier: CraftingTier.Military,
    ingredients: [
      { itemId: 11, quantity: 100 }, // Sulfur
      { itemId: 10, quantity: 50 }, // Metal Fragments
      { itemId: 6, quantity: 30 }, // Cloth
      { itemId: 15, quantity: 10 }, // Low Grade Fuel
    ],
    outputItemId: 90,
    outputQuantity: 1,
    craftTimeSeconds: 30,
    requiredStation: 'workbench',
    requiredBlueprint: true,
  },
  51: {
    id: 51,
    name: 'Storage Box',
  ...
  52: {
    ...
    tier: CraftingTier.Intermediate,
    ingredients: [
      { itemId: 1, quantity: 250 },
      { itemId: 10, quantity: 50 },
    ],
    outputItemId: 92,
    outputQuantity: 1,
    craftTimeSeconds: 25,
  ...
  54: {
    ...
    tier: CraftingTier.Primitive,
    ingredients: [{ itemId: 1, quantity: 100 }],
    outputItemId: 94,
    outputQuantity: 1,
    craftTimeSeconds: 10,
  },
